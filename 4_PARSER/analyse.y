...
%{
    ...
    extern FILE *yyin;
%}
%token op dec_num oct_num hex_num pre_pro_dir header_file endStmt struct_KW main_KW for_KW while_KW if_KW else_KW assign_op string id dataT return_KW

 
%%
S : E    {printf("Reached the end\n");}  | dataT id endStmt  {printf("Reached the end\n");}
;

E : '#' pre_pro_dir "<" header_file ">" EDash {printf("e1\n");}
;
...
EDash : E {printf("e2\n");}| 
        ...
        struct_KW id "{" var_dec "}" endStmt EDash {printf("e6\n");}|
        F {printf("e7\n");}|

;

F : dataT main_KW "(" ")" "{" body "}" H {printf("e8\n");}
;
...
void_func_call : id "(" argu_list ")" {printf("e20\n");}
;

return_func_call : dataT id "=" void_func_call {printf("e21\n");}
;

argu_list : expr "," argu_list | expr  {printf("e22\n");}
;
...
var_dec : dataT id {printf("e28\n");}|
          var_assign {printf("e29\n");}
;

var_assign : dataT id "=" expr {printf("e30\n");}
;

whileLoop : while_KW "(" expr ")" "{" stmts "}" {printf("e31\n");}

ifStmt : if_KW "(" expr ")" "{" stmts "}" {printf("e32\n");}|
         if_KW "(" expr ")" "{" stmts "}" elseStmt {printf("e33\n");}
;

elseStmt : else_KW ifStmt {printf("e34\n");}|
           else_KW "{" stmts "}" {printf("e35\n");}
;

forLoop : for_KW "(" var_assign ";" expr ";" stmt ")" "{" stmts "}" {printf("e36\n");}
;

func_def : dataT id "(" para_list ")" "{" stmts "}" {printf("e37\n");}
; 

para_list : "," dataT para_list {printf("e38\n");}|
            dataT id para_list {printf("e39\n");}	
	{printf("e40\n");}
;

func_declaration : dataT id "(" dec_para_list ")" {printf("e41\n");}
;

dec_para_list : para_list {printf("e45\n");}|
                dataT dec_para_list {printf("e42\n");}|
                "," dataT dec_para_list {printf("e43\n");}|
	{printf("e46\n");}
;
